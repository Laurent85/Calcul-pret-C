...
namespace Calcul_prêt_C
{
    ...
    {        
        ...
        {            
            double restant = Convert.ToDouble(Principal.somme_principal);
            double durée = Convert.ToDouble(Principal.durée_principal);
            double mensualités = Convert.ToDouble(Principal.mensualités_principal);
            double taux = Convert.ToDouble(Principal.taux_principal);
            double intérêts = 0;
            double capital = 0;
